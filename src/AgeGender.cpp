...
int main(int argc, char** argv)
{
   ...
   String keys =
    ...
    String faceProto = parser.get<String>("fproto"); 
    String faceModel = parser.get<String>("fmodel"); 
    String ageProto = parser.get<String>("aproto"); 
    String ageModel = parser.get<String>("amodel"); 
    String genderProto = parser.get<String>("gproto"); 
    String genderModel = parser.get<String>("gmodel"); 
